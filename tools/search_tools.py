...
@tool(
    name="get_implementation",  # Custom name for the tool
...
def get_implementation(full_qualified_name: str) -> str:
    ...
    """
    print(f"get implementation called with: {full_qualified_name}")
    file_logger.info(f"get implementation called with: {full_qualified_name}")
